...
@pytest.mark.parametrize(
    ("allow_merge_commit", "prohibit"),
    [(True, False), (False, True)],
)
def test_MatchingStatus(allow_merge_commit, prohibit):
...
def test_ErrorResolutionWhenProhibited():
    result = _Evaluate({"allow_merge_commit": True}, prohibit=True)
...
# ----------------------------------------------------------------------
def test_MergeCommitWhenProhibited():
    result = _Evaluate({"allow_merge_commit": True}, prohibit=True)
